...
def basicUnitTest():
	...
	mode = sys.argv[1]# this takes Command line arguments in python.0 = python, 1 = server, 2 = client. in this scenario, so CL command
	
	# python3 Lab1DSubmissionUpdated.py client runs the client version of this code.  server runs the other.
	print("\n",mode)
